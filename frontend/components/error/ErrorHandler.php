...
namespace frontend\components\error;
use Yii;
...
class ErrorHandler extends \yii\web\ErrorHandler
{
   ...
   // public $exceptionView = '@backend/views/site/error.php';
    ...
    {   
        if (Yii::$app->params['enableErrorMailService'] && ( isset($exception->statusCode) && $exception->statusCode != 404)) {
    ...
    */
    ...
    {   
        ...
        try {
            ...
            $logo = null;
            $subject = 'Re-member error report';
