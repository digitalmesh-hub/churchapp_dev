...
<head>
	...
	<title>RE-MEMBER RSVP ACKNOWLEDGEMENT</title>
...
<td valign="top" style="margin:0 auto">
			<table cellspacing="0" border="0" align="center" style="background: #fff; border: 1px solid #ccc; margin:0 auto" cellpadding="0" width="600">
				<tr>
                    ...
                    <td width="129" style="text-align:right;"><img src="lotus-club-logo.jpg"/>&nbsp;&nbsp;&nbsp;</td>
				</tr>
				<tr>
					<td colspan="2">
...
<span style="color:#666;"><?= Html::encode($institutionname);?></span><br/>
