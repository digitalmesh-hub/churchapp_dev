...
<head>
	...
	<title>RE-MEMBER FEEDBACK</title>
                     ...
                     <td width="334">
                      <div style="width:200px; display:block;
                        ...
                        <div style="width:100%; display:block;
                          float:left; text-align:center; font-size:13px;
                          font-weight:bold;">Rating</div>
                        <div style="width:100%; display:block;
                          float:left; text-align:center;
                          margin-top:10px;"><img src="<?= $ratingImage; ?>"/>
                        </div>
                      </div>
                    </td>
                    <td width="129" style="text-align:right;"><img style='width:120px; height:120px;margin-right: 5px; margin-top: 5px;' src='<?= !empty($memberImage) ? $memberImage : $message->embed(Yii::getAlias('@backend'.'/assets/theme/images/default-user.png')); ?>'/></td>
				</tr>
				<tr>
					<td colspan="2">
...
<span style="color:#0165AF;">Kind regards</span><br/>
<strong style="color:#0165AF;"><?= Html::encode($name)?></strong><br/>
<span style="color:#666;"><?= Html::encode($memberno);?></span><br/>
