...
<table cellspacing="0" border="0" style="background-color: #fff;font-family:Tahoma, Geneva, sans-serif; font-size:13px" cellpadding="0" width="100%">
  <tr>
    <td valign="top" style="margin:0 auto"><table cellspacing="0" border="0" align="center" style="background: #fff; border: 1px solid #ccc; margin:0 auto" cellpadding="0" width="600">
        <tr>
          <td width="135" style="text-align:left;"><img style="width:120px; height:120px;" src="<?= $institutionLogo ?>"/></td>
        </tr>
        <tr>
          <td colspan="3"><table cellspacing="0" border="0" cellpadding="0" width="100%" align="center">
              <tr>
                <td  valign="top" style="padding: 0 10px; font-family:Tahoma, Geneva, sans-serif; font-size: 13px;  color:#000; line-height:25px" width="600" colspan="2"><br>
                  Dear <?= $name ?>,<br>
                  We have received your request for updating your membership profile data. Please click on the link below to edit your data. We will review and update the data at the earliest.<br/>
                  <br/>
                  </td>
              </tr>
              
              <tr>
                 <td colspan="2" style="padding: 0 10px; font-family:Tahoma, Geneva, sans-serif; font-size: 13px;  color:#000; line-height:25px">
                 <a href="<?= $generatedlink ?>" style="padding:5px;border: 1px solid #0173bf;text-decoration:none;color: #0173bf;">Request Link</a>
                 </td>
              </tr>
              ...
              <tr>
                <td colspan="2" style="padding:10px; font-size:12px; line-height:25px;"><span style="color:#0165AF;">Thank You,</span><br/>
                  <strong style="color:#0165AF;"><?= $institutionname; ?></strong><br/>
