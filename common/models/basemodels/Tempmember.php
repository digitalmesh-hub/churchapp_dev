...
/**
 * This is the model class for table "tempmember".
 *
 * @property int $id
 ...
 * @property string $temp_membertitle
 * @property string $temp_spousetitle
 ...
 * @property int $temp_member_mobile1_countrycode
 * @property int $temp_spouse_mobile1_countrycode
 * @property int $temp_member_business_phone1_countrycode
 ...
 * @property int $temp_member_residence_Phone1_countrycode
 ...
 * @property Country $tempMemberBusinessPhone2Countrycode
 * @property Country $tempMemberBusinessPhone3Countrycode
 * @property Usercredentials $tempCreatedby
 * @property Institution $tempInstitution
 * @property Country $tempMemberBusinessPhone1Countrycode
 * @property Country $tempMemberMobile1Countrycode
 * @property Member $tempMember
 * @property Usercredentials $tempModifiedby
 * @property Country $tempMemberResidencePhone1Countrycode
 * @property Country $tempSpouseMobile1Countrycode
 */
class Tempmember extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['temp_member_business_phone2_countrycode'], 'exist', 'skipOnError' => true, 'targetClass' => Country::className(), 'targetAttribute' => ['temp_member_business_phone2_countrycode' => 'countryid']],
            [['temp_member_business_phone3_countrycode'], 'exist', 'skipOnError' => true, 'targetClass' => Country::className(), 'targetAttribute' => ['temp_member_business_phone3_countrycode' => 'countryid']],
            ...
            [['temp_member_business_phone1_countrycode'], 'exist', 'skipOnError' => true, 'targetClass' => Country::className(), 'targetAttribute' => ['temp_member_business_phone1_countrycode' => 'countryid']],
            [['temp_member_mobile1_countrycode'], 'exist', 'skipOnError' => true, 'targetClass' => Country::className(), 'targetAttribute' => ['temp_member_mobile1_countrycode' => 'countryid']],
    ...
    {
        return $this->hasMany(Tempdependant::className(), ['tempmemberid' => 'id']);
    }
    ...
    {
        return $this->hasMany(Tempdependantmail::className(), ['tempmemberid' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getTempMemberBusinessPhone2Countrycode()
    {
        return $this->hasOne(Country::className(), ['countryid' => 'temp_member_business_phone2_countrycode']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getTempMemberBusinessPhone3Countrycode()
    {
        return $this->hasOne(Country::className(), ['countryid' => 'temp_member_business_phone3_countrycode']);
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getTempMemberBusinessPhone1Countrycode()
    {
        return $this->hasOne(Country::className(), ['countryid' => 'temp_member_business_phone1_countrycode']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getTempMemberMobile1Countrycode()
    {
        return $this->hasOne(Country::className(), ['countryid' => 'temp_member_mobile1_countrycode']);
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function getTempMemberResidencePhone1Countrycode()
    {
        return $this->hasOne(Country::className(), ['countryid' => 'temp_member_residence_Phone1_countrycode']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getTempSpouseMobile1Countrycode()
    {
        return $this->hasOne(Country::className(), ['countryid' => 'temp_spouse_mobile1_countrycode']);
    }
}
