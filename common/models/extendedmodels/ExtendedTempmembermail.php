...
use Yii;
use common\models\basemodels\Tempmembermail;
 ...
 */
class ExtendedTempmembermail extends Tempmembermail
{
	/**
	 * @inheritdoc
	 */
	...
	public function rules()
	{
		return [
				...
				[['temp_membersince', 'temp_member_dob', 'temp_spouse_dob', 'temp_dom', 'temp_app_reg_member', 'temp_app_reg_spouse', 'temp_lastupdated', 'temp_createddate'], 'safe'],
