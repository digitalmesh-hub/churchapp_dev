...
echo Html::hiddenInput(
    'getSelectedRoleCategory',
    \Yii::$app->params['ajaxUrl']['getSelectedRoleCategory-Url'],
    [
        'id'=>'getSelectedRoleCategory-url'
    ]
);
    ...
    <div class="row">
            ...
            <div class = "Mtop10">
                ...
                <div class="col-md-12 col-sm-12 Mtopbot20">
                    <fieldset>
                        <legend style="font-size: 20px;">Edit Category Privileges
                        <?= Html::a('Back to Listing', ['rbac/roles', 'id' => $institutionModel->id], ['class' => 'btn btn-primary btn-sm manage rightalign Mtop-5']) ?>
                        </legend>
                      <?= Html::beginForm(['rbac/manage-category', 'id' => $institutionModel->id], 'post', ['id' => 'role-category-form']) ?>
<div class="blockrow Mtop20">
    <div class="privilageedit-holder">
        <div class="col-md-12 Mtop10">
            <div class="form-group category-holder">
                <label class="col-md-4 col-sm-4 control-label text-left" for="request-description">Role Group</label>
                <div class="col-md-6 col-sm-8">
                    <?= Html::dropDownList(
                        ...
                        [
                        'class' => "form-control",
                        'prompt' => 'Please select role group',
                        'id' => 'role_group'
                        ]) ?>  
                </div>
            </div>
            <div id="result">
                <div id="rolecategorylist">
                    <ul class="list-group">
                        <li>
                            <?= Html::button('Add New Category', [
                            'class' => 'btn btn-primary btn-sm manage pull-left',
                            'id' => 'add-new-category',
                            'title' => yii::t('app', 'Add New Category')
                            ]
                        ) ?>
                        </li>
        ...
        <?= Html::submitButton('Save', ['class' =>  'btn btn-success btn-sm manage Mtop20' , 'id' => 'btn-category-save', 'title' => 'Save']) ?>
    </div>
</div>
    <?= Html::endForm() ?>
                    </fieldset>
