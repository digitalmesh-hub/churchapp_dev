   ...
   <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title" id="exportFilterModalLabel">Export Members with Filters</h4>
         </div>
         <?php $form = ActiveForm::begin(['action' => ['/member/export-members-filtered'], 'method' => 'get', 'id' => 'export-filter-form']); ?>
         <div class="modal-body">
               ...
               <div class="col-md-12">
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <?= Html::textInput('membership_type', '', ['class' => 'form-control', 'placeholder' => 'e.g., Regular, Patron, Honorary, etc.']) ?>
                        <p class="help-block">Leave empty to include all membership types</p>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  <h5><strong>Marriage Date Filter</strong></h5>
                  <div class="col-md-4">
                     <div class="form-group">
                        <label>Marriage Month Only</label>
                        <?= Html::dropDownList('marriage_month', '', [
                           ...
                           '11' => 'November',
                           '12' => 'December'
                        ], ['class' => 'form-control', 'id' => 'marriage-month']) ?>
                        <small class="text-muted">Select a month to filter marriages in that month</small>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
                        <label>Marriage From Date</label>
                        <?= Html::input('date', 'marriage_date_from', '', ['class' => 'form-control', 'id' => 'marriage-date-from']) ?>
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <?= Html::input('date', 'marriage_date_to', '', ['class' => 'form-control', 'id' => 'marriage-date-to']) ?>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="row">
               <div class="col-md-12">
                  ...
                  <div class="col-md-4">
                     <div class="form-group">
                        <label>Birthday Month Only</label>
                        <?= Html::dropDownList('birthday_month', '', [
                           ...
                           '11' => 'November',
                           '12' => 'December'
                        ], ['class' => 'form-control', 'id' => 'birthday-month']) ?>
                        <small class="text-muted">Select a month to filter birthdays in that month</small>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
                        <label>Birthday From Date</label>
                        <?= Html::input('date', 'birthday_date_from', '', ['class' => 'form-control', 'id' => 'birthday-date-from']) ?>
                        <small class="text-muted">Or specify exact date range</small>
                     </div>
                  </div>
                  <div class="col-md-4">
                     <div class="form-group">
                        ...
                        <?= Html::input('date', 'birthday_date_to', '', ['class' => 'form-control', 'id' => 'birthday-date-to']) ?>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="col-md-12">
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        <div class="checkbox">
                           <label>
                              <?= Html::checkbox('include_dependants', true, ['id' => 'include-dependants', 'value' => 1]) ?>
         ...
         <div class="modal-footer">
            ...
            <button type="button" class="btn btn-success" id="export-filtered-btn">Export</button>
         </div>
         <?php ActiveForm::end(); ?>
      </div>
   </div>
...
$this->registerJs("
   ...
   $('#export-filtered-btn').on('click', function(e) {
      e.preventDefault();
      e.stopPropagation();
   ...
   $('#export-filter-form').on('submit', function(e) {
      e.preventDefault();
      $('#export-filtered-btn').trigger('click');
      return false;
   });
   ...
   $('#exportFilterModal').on('hidden.bs.modal', function() {
      $('#export-loading-overlay').fadeOut(300);
      $('#export-filtered-btn').prop('disabled', false).html('Export');
   });
   
   // Disable date range when month is selected
   $('#marriage-month').on('change', function() {
      if ($(this).val()) {
         $('#marriage-date-from, #marriage-date-to').val('').prop('disabled', true);
      } else {
         $('#marriage-date-from, #marriage-date-to').prop('disabled', false);
      }
   });
   
   $('#birthday-month').on('change', function() {
      if ($(this).val()) {
         $('#birthday-date-from, #birthday-date-to').val('').prop('disabled', true);
      } else {
         $('#birthday-date-from, #birthday-date-to').prop('disabled', false);
      }
   });
   
   // Disable month when date range is selected
   $('#marriage-date-from, #marriage-date-to').on('change', function() {
      if ($('#marriage-date-from').val() || $('#marriage-date-to').val()) {
         $('#marriage-month').val('').prop('disabled', true);
      } else {
         $('#marriage-month').prop('disabled', false);
      }
   });
   
   $('#birthday-date-from, #birthday-date-to').on('change', function() {
      if ($('#birthday-date-from').val() || $('#birthday-date-to').val()) {
         $('#birthday-month').val('').prop('disabled', true);
      } else {
         $('#birthday-month').prop('disabled', false);
      }
   });
