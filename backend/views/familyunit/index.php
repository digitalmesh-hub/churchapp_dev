...
$this->registerJsFile(
    $assetName->baseUrl . '/theme/js/Remember.familyUnit.ui.js',
    [
        'depends' => [
                AppAsset::className()
        ]
...
?>
<div class="col-md-12 col-sm-12 pageheader Mtop15">Family Unit</div>
    <div class="col-md-12 col-sm-12 contentbg">
        <div class="col-md-12 col-sm-12 Mtopbot20">
<?php   
   $path   = ($update == 'add') ?  'familyunit/create' : 'familyunit/update/'.$model->familyunitid ;
   $button = ($update == 'add') ?  'Add' : 'Update' ;
?>
  <div class="inlinerow Mtop20">
                        <div class="col-md-12 col-sm-12"><strong>Please enter Family Unit </strong></div>
    ...
    <?php $form = ActiveForm::begin(['action' => [$path],'options' => ['method' => 'post']]) ?>                                           
        <div class="inlinerow Mtop10">
            ...
            <div class="col-md-2 col-sm-2">
                <?= Html::submitButton( '<span class="glyphicon glyphicon-plus-sign"></span>'.'&nbsp'.$button, ['class' => 'btn btn-primary','id' => 'addfamilyunit', 'title' => $button]) ?>
                <a href="/familyunit/index" class="btn btn-primary clearbutton" title = 'Clear' id="clearbutton">&nbsp;Clear</a>
            </div>
    ...
    <?php ActiveForm::end(); ?>
        ...
        <!-- Validation errors -->
            <div class="col-md-6 col-sm-6" id="ErrorDiv">
                <div class="alert alert-danger text-center" hidden="hidden" id="ErrorMessageLabel" role="alert">Family Unit Cannot be blank</div>
            </div>
                            <!-- /.Validation errors -->
        </div>
    </div>
