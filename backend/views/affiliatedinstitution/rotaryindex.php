                        ...
                        <?php Pjax::begin(); ?>
                            <?= GridView::widget([
                                ...
                                'columns' => [
                                    ...
                                    [
                                        'attribute' => 'meetingvenue',
                                        'label'=>'Meeting Venue',
                                        'headerOptions'=> 
                                            ['style'=>'text-align:center'],
                                       'contentOptions' => ['class'=>'text-center'],
                                        'value'=>function ($model) { 
                                            return $model->meetingvenue ? $model->meetingvenue : '';
                                        },
                                    ],
                                    [
                                        ...
                                        'contentOptions' => ['class'=>'text-center'],
                                        'value'=>function ($model) { 
                                            return $model->meetingday ? $model->meetingday : '';
                                        },
                                    ],
                                    [
                                        'attribute' => 'meetingtime',
                                        'label'=>'Meeting Time',
                                       'value'=>function ($model) { 
                                            return $model->meetingtime ? $model->meetingtime : '';
                                        },
                                        'headerOptions'=> 
                                            ['style'=>'text-align:center'],
                                        'contentOptions' => ['class'=>'text-center'],
