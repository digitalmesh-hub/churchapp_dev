                ...
                <div class="blockrow Mtop50">
                    ...
                    <div class="inlinerow">
                        <div class="col-md-2 col-sm-2 col-md-offset-3 col-sm-offset-3">
                            <img style="width: 160px; border-radius: 25px; height: 150px;" id='institutionImage' class="form-control" src="<?php echo $assetName->baseUrl; ?>/theme/images/institution-icon-grey.png" />
                        </div>
                    ...
                    <div class="inlinerow Mtop50">
                                ...
                                <div class="col-md-7 col-sm-7">
                                    <?= $form->field($formModel, 'timezone')->dropDownList(
                                        ...
                                        [
                                            ...
                                            'options' => [
                                                'Asia/Kolkata' => array('selected' => true) //set defualt timezone to india.
                                            ]
                                        ]
                                    )
                                        ->label(false);
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="inner-rows">
                                ...
                                <div class="col-md-7 col-sm-7 phone-div">
                                    <?= $form->field($formModel, 'phone1_countrycode')->textInput(
                                        [
                                            'maxlength' => 4,
                                            'class' => 'citycodes form-control number-check'
                                        ]
                                    )->label(false) ?>
                        ...
                        <div class="inlinerow Mtop30 text-center">
                            <?= Html::submitButton('Save', [
                                'class' =>  'btn btn-success save-institution submit',
